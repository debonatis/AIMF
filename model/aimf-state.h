...
namespace ns3 {
    namespace aimf {
        ...
        protected:
            ...
            AssociationSet m_associationSet; ///<	Association Set (\RFC{3626}, section12.2). Associations obtained from HMA messages generated by other nodes.
            Associations m_associations; ///< The node's local Host Network Associations that will be advertised using HMA messages.
